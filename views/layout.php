...
<head>
    ...
    <title>Parcial1_MACS</title>
</head>

<body class="bg-light d-flex flex-column min-vh-100">
    <nav class="navbar navbar-dark bg-primary navbar-expand-lg shadow-sm py-3">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="/parcial1_macs/">
                <i class="bi bi-cpu me-2"></i> Parcial1_MACS
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <a class="nav-link text-white fw-semibold" href="/parcial1_macs/libros">
                        <i class="bi bi-book me-1"></i>Libros Prestados
                    </a>
                </div>
                <form class="d-flex ms-lg-3 mt-3 mt-lg-0" role="search" method="GET" action="/parcial1_macs/libros">
